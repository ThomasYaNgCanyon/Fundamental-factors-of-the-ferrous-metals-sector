...
# 回测框架所在路径
sys.path.append("C:/Users/ifwha/OneDrive - CUHK-Shenzhen/桌面/工作/A03_回测框架/截面项目/dataprepare/code")
...
# 回测所依赖的数据路径
SDATAPATH = "C:/Users/ifwha/OneDrive - CUHK-Shenzhen/桌面/工作/A03_回测框架/截面数据"
...
if __name__ == "__main__":
    ...
    # 保存回测结果的路径。请使用绝对路径！
    sRstPath = "C:/Users/ifwha/OneDrive - CUHK-Shenzhen/桌面/工作/A06_策略研究/黑色板块策略/result"
